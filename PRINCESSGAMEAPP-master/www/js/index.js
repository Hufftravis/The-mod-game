...
function createNewToDo()
{
    ...
    var todo = prompt("Enter Name","");
    if (todo != null)
    {
        if (todo == "")
        {
            alert("You must enter a name to enter a score.");
        }
        else
        {
            // append the new to-do with the table
            todoDictionary = { check : 0 , text : todo +": "+ scoreCard.innerHTML}; //this is where we store local permamenet data
